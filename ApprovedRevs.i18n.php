...
Instead, a blank page will be shown.',
	...
	'approvedrevs-grandfatheredpages' => 'Grandfathered pages',
	'approvedrevs-grandfathered-description' => 'These pages have approved revisions despite the fact that they are neither considered approvable per [[MediaWiki:Approvedrevs-permissions]] nor do they contain the APPROVEDREVS magic word. Pages should either have approvals removed or be added to [[MediaWiki:Approvedrevs-permissions]].',
	...
	'approvedrevs-grandfatheredfiles' => 'Grandfathered files',
	'approvedrevs-view' => 'View pages:',
	'approvedrevs-viewfiles' => 'View files:',
...
Kumbaya, sarong blangkong pahina an ipapahiling.',
	...
	'approvedrevs-noapprovedrevision' => 'Ini iyo an pinakahuring rebisyon kaining pahina; ini dae nagkaigwa nin aprubadong rebisyon.',
...
À la place, une page vide sera affichée.',
	...
	'approvedrevs-noapprovedrevision' => 'Ceci est la dernière révision de cette page ; elle n’a pas de révision approuvée.',
...
Al suo posto verrà mostrata una pagina vuota.',
	...
	'approvedrevs-noapprovedrevision' => "Questa è l'ultima versione di questa pagina; che non ha alcuna versione approvata.",
 ...
 */
$messages['ko'] = array(
	'approvedrevs-desc' => '승인한 문서의 판 하나를 설정합니다',
	'approvedrevs-logname' => '판 승인 기록',
	'approvedrevs-logdesc' => '판을 승인한 기록입니다.',
	'approvedrevs-approve' => '승인',
...
대신에 빈 문서가 보여집니다.',
	...
	'approvedrevs-approvedandlatest' => '이 문서의 승인한 판은 최신 판입니다.',
	'approvedrevs-blankpageshown' => '이 문서의 승인한 판이 없습니다.',
	'approvedrevs-noapprovedrevision' => '이 문서의 최신 판입니다; 승인된 판이 없습니다.',
	'approvedrevs-editwarning' => '현재 편집하고 있는 문서는 이 문서의 최신 판이며, 기본으로 보여지는 승인된 판과는 다름에 주의하세요.',
	'approvedrevs' => '승인한 판',
	'approvedrevs-approvedpages' => '승인한 판이 있는 모든 문서',
	'approvedrevs-notlatestpages' => '승인한 판의 문서는 최신 판이 아닙니다',
	'approvedrevs-unapprovedpages' => '승인하지 않은 문서',
	'approvedrevs-view' => '보기:',
	'approvedrevs-revisionnumber' => '$1 판',
	'approvedrevs-approvedby' => '{{GENDER:$3|$1}} 사용자가 $4 $5에 승인함',
	'approvedrevs-difffromlatest' => '최신판과의 비교',
	'approvedrevs-approvelatest' => '최신판 승인',
	'approvedrevs-approvethisrev' => '이 판을 승인합니다.',
	'approvedrevs-viewlatestrev' => '최신 판을 봅니다.',
	'right-approverevisions' => '승인한 위키 문서의 특정 판 설정',
	'right-viewlinktolatest' => '승인한 판이 있는 문서의 위에 설명 텍스트 보이기',
);
...
Het is niet de meeste recente versie.',
	...
	'approvedrevs-noapprovedrevision' => 'Dit is de meest recente versie van deze pagina. Er is geen goedgekeurde versie.',
...
$messages['roa-tara'] = array(
	...
	'approvedrevs-logdesc' => "Quiste jè l'archivije de le revisiune ca onne state approvate.",
	'approvedrevs-approve' => 'approve',
	'approvedrevs-unapprove' => 'scitte',
	'approvedrevs-approvesuccess' => "'A revisione d'a pàgene ha state 'mbostate cumme 'na versione approvate.",
	'approvedrevs-unapprovesuccess' => "Non ge stè cchiù 'na versione approvate pe sta pàgene.
Invece, 'a revisione cchiù recende avène fatte vedè.",
	'approvedrevs-unapprovesuccess2' => "Non ge stè cchiù 'na versione approvate pe sta pàgene.
Invece, 'na pàgena vacande avène fatte vedè.",
	'approvedrevs-approveaction' => '\'mboste $2 cumme \'na revisione approvate pe "[[$1]]"',
	'approvedrevs-unapproveaction' => 'live \'a revisione approvate pe "[[$1]]"',
	'approvedrevs-notlatest' => "Queste jè 'na revisione approvate de sta pàgene; non g'à l'urtema.",
	'approvedrevs-approvedandlatest' => "Queste jè 'na revisione approvate de sta pàgene, apparte ca jè pure 'a cchiù recende.",
	'approvedrevs-blankpageshown' => 'Nisciuna revisione ha state approvate pe sta pàgene.',
	'approvedrevs-noapprovedrevision' => "Queste jè l'urtema revisione de sta pàgene; jedde non ge tène 'na revisione approvate.",
	'approvedrevs-editwarning' => "Pe piacere vide ca tu mò ste cange l'urtema revisione de sta pàgene, 'a quale non g'è approvate cumme te face vedè de base.",
	'approvedrevs' => 'Revisiune approvate',
	'approvedrevs-approvedpages' => "Tutte le pàggene cu 'na revisione approvate",
	'approvedrevs-notlatestpages' => "Pàggene ca tènene 'a revisione approvate ca non g'è l'urteme",
	...
	'right-approverevisions' => "'Mboste 'na revisione secure de 'na pàgene uicchi cumme approvate",
	'right-viewlinktolatest' => "'Ndruche 'u teste ca spieghe 'ngape a le pàggene ca onne 'na revisione approvate",
);
